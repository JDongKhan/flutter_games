...
class Ember<T extends FlameGame> extends SpriteAnimationComponent with HasGameRef<T> {
...
class MovableEmber extends Ember<BirdGame> with CollisionCallbacks, KeyboardHandler {
