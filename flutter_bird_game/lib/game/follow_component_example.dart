...
class FollowComponentExample extends FlameGame with HasCollisionDetection, HasKeyboardHandlerComponents, TapDetector {
  ...
  void onTap() {
    print('tap');
    ember.position = Vector2(ember.position.x - 10, ember.y);
    super.onTap();
  }
}

class MovableEmber extends Ember<FollowComponentExample> with CollisionCallbacks, KeyboardHandler, TapCallbacks {
  ...
  void onTapUp(TapUpEvent event) {
    print('tap');
    position = Vector2(position.x - 1, y);
    super.onTapUp(event);
  }
}
