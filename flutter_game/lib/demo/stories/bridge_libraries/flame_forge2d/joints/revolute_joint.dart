...
class RevoluteJointExample extends Forge2DGame {
  ...
  RevoluteJointExample() : super(gravity: Vector2(0, 10.0), world: RevoluteJointWorld());
}

class RevoluteJointWorld extends Forge2DWorld with TapCallbacks, HasGameReference<Forge2DGame> {
  @override
...
class CircleShuffler extends BodyComponent {
  ...
  Body createBody() {
    ...
    final jointDef = RevoluteJointDef()..initialize(body, ball.body, body.position);
