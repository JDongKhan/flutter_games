...
class MouseJointExample extends Forge2DGame {
  ...
  MouseJointExample() : super(gravity: Vector2(0, 10.0), world: MouseJointWorld());
}

class MouseJointWorld extends Forge2DWorld with DragCallbacks, HasGameReference<Forge2DGame> {
  late Ball ball;
