...
class FrictionJointExample extends Forge2DGame {
  ...
  FrictionJointExample() : super(gravity: Vector2.all(0), world: FrictionJointWorld());
}

class FrictionJointWorld extends Forge2DWorld with TapCallbacks, HasGameReference<Forge2DGame> {
  late Wall border;
  late Ball ball;
