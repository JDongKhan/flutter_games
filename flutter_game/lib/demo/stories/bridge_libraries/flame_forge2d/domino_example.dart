...
class DominoExample extends Forge2DGame {
  ...
  DominoExample() : super(gravity: Vector2(0, 10.0), world: DominoExampleWorld());
}

class DominoExampleWorld extends Forge2DWorld with TapCallbacks, HasGameReference<Forge2DGame> {
