...
class ContactCallbacksExample extends Forge2DGame {
  ...
  ContactCallbacksExample() : super(gravity: Vector2(0, 10.0), world: ContactCallbackWorld());
}

class ContactCallbackWorld extends Forge2DWorld with TapCallbacks, HasGameReference<Forge2DGame> {
  @override
