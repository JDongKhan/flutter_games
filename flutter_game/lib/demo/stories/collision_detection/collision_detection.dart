...
import 'bouncing_ball_example.dart';
import 'circles_example.dart';
import 'collidable_animation_example.dart';
import 'multiple_shapes_example.dart';
import 'multiple_worlds_example.dart';
import 'quadtree_example.dart';
import 'raycast_example.dart';
import 'raycast_light_example.dart';
import 'raycast_max_distance_example.dart';
import 'raytrace_example.dart';
...
void addCollisionDetectionStories(Dashbook dashbook) {
  dashbook.storiesOf('Collision Detection')
    ..add(
      ...
      codeLink: baseLink('collision_detection/collidable_animation_example.dart'),
    ...
    ..add(
      ...
      codeLink: baseLink('collision_detection/raycast_max_distance_example.dart'),
