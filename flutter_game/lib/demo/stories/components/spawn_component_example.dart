...
class SpawnComponentExample extends FlameGame with TapDetector {
  static String description = 'Tap on the screen to start spawning Embers within different shapes.';
    ...
    switch (shapeType) {
      case Shapes.rectangle:
        shape = Rectangle.fromCenter(
          center: info.eventPosition.global,
          size: Vector2.all(200),
        );
      case Shapes.circle:
        shape = Circle(info.eventPosition.global, 150);
      case Shapes.polygon:
        shape = Polygon(
          [
            Vector2(-1.0, 0.0),
