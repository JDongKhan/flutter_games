...
class MultitapAdvancedExample extends FlameGame with MultiTouchTapDetector, MultiTouchDragDetector {
  ...
  void onTapDown(int pointerId, TapDownInfo info) {
    taps[pointerId] = info.eventPosition.global.toPositionedRect(tapSize);
  }
